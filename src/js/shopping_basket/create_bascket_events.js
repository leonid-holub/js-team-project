...
const binIcon = `<svg class="btn-del-icon" width="20" height="20" viewBox="0 0 44 32"
            xmlns="http://www.w3.org/2000/svg"><path d="M4 10v20c0 1.1 0.9 2 2 2h18c1.1 0 2-0.9 2-2v-20h-22zM10 28h-2v-14h2v14zM14 28h-2v-14h2v14zM18 28h-2v-14h2v14zM22 28h-2v-14h2v14z"></path>
